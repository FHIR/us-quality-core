...
1. **SHALL** support searching for records associated with a patient using the **[`patient`](SearchParameter-us-quality-core-allergyintolerance-patient.html)** search parameter:
   ...
   *Implementation Notes:* Fetches a Bundle of AllergyIntolerance resources for the specified patient. ([how to search by reference]({{site.data.fhir.path}}search.html#reference))
