...
1. **SHALL** support searching for records associated with a patient using the **[`patient`](SearchParameter-us-quality-core-familymemberhistory-patient.html)** search parameter:

   `GET [base]/FamilyMemberHistory?patient={Patient/}[id]`

   Example:

     1. GET [base]/FamilyMemberHistory?patient=Patient/1137192
   ...
   *Implementation Notes:* Fetches a Bundle of FamilyMemberHistory resources for the specified patient. ([how to search by reference]({{site.data.fhir.path}}search.html#reference))
