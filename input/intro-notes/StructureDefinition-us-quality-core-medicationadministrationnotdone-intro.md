<div xmlns="http://www.w3.org/1999/xhtml" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://hl7.org/fhir ../../input-cache/schemas/R5/fhir-single.xsd">
  ...
  ["MedicationAdministrationNotDone": "Low Dose Unfractionated Heparin for VTE Prophylaxis"] VTEMedication
    where VTEMedication.category ~ USQualityCoreCommon."Inpatient"
...
<li>medication[x].extension:notDoneValueSet: (USCDI+ Quality) Url of a value set of activities not requested or performed</li>
</ul>
