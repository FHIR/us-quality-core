...
<table>
  ...
  <p>For CareTeam, US Quality Core includes <code>patient</code> and <code>status</code> search parameters, with required support for the <code>patient+status</code> combination. These searches support patient-scoped retrieval and status-sensitive or negation workflows for in-scope USCDI+ Quality data.</p>
