...
<h3>Examples</h3>
  ...
  <p>For Coverage, US Quality Core includes <code>patient</code> search parameter. These searches support patient-scoped retrieval for in-scope USCDI+ Quality data.</p>
