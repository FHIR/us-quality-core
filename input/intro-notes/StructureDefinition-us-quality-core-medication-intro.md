...
<code>define function "GetMedicationCode"(request MedicationRequest):
  ...
  <p>For Medication, US Quality Core includes <code>code</code> search parameter. These searches support filtering by clinical concept or quality logic code path for in-scope USCDI+ Quality data.</p>
