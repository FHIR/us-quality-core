...
1. **SHALL** support searching for records associated with a patient using the **[`patient`](SearchParameter-us-quality-core-coverage-patient.html)** search parameter:

   `GET [base]/Coverage?patient={Patient/}[id]`

   Example:

     1. GET [base]/Coverage?patient=Patient/1137192
   ...
   *Implementation Notes:* Fetches a Bundle of Coverage resources for the specified patient. ([how to search by reference]({{site.data.fhir.path}}search.html#reference))
