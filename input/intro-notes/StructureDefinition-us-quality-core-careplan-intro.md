...
<table>
  ...
  <p>For CarePlan, US Quality Core includes <code>patient</code> and <code>category</code> search parameters, with required support for the <code>patient+category</code> combination. These searches support patient-scoped retrieval and filtering by clinical concept or quality logic code path for in-scope USCDI+ Quality data.</p>
