...
The US Quality Core Server CapabilityStatement does not add US Quality Core-specific search requirements for PractitionerRole. This resource is generally reached through references from in-scope quality resources rather than used as a primary USCDI+ Quality retrieval entry point.
